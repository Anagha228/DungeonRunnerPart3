...
class CCharset(ctypes.Structure):
    _fields_ = [
        ("wall", ctypes.c_char),
        ("floor", ctypes.c_char),
...
lib.game_engine_render_room.argtypes = [GameEngine, ctypes.c_int, ctypes.POINTER(ctypes.c_char_p)]
lib.game_engine_render_room.restype = Status
...
lib.game_engine_get_charset.argtypes = [GameEngine, ctypes.POINTER(CCharset)]
...
lib.player_set_position.argtypes = [Player, ctypes.c_int, ctypes.c_int]
lib.player_set_position.restype = Status

lib.player_move_to_room.argtypes = [Player, ctypes.c_int]
lib.player_move_to_room.restype = Status

lib.player_reset_to_start.argtypes = [Player, ctypes.c_int, ctypes.c_int, ctypes.c_int]
lib.player_reset_to_start.restype = Status

lib.player_try_collect.argtypes = [Player, ctypes.c_void_p]
lib.player_try_collect.restype = Status
